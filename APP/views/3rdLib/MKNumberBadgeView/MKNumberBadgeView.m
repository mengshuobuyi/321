...
- (void)drawRect:(CGRect)rect 
{
    ...
    if(self.value > 99) {
        ...
        numberString = [NSString stringWithFormat:@"%d",self.value];
    }
...
//	CGPathMoveToPoint( badgePath, NULL, arcRadius, 0 );
	...
	CGPathAddLineToPoint( badgePath, NULL, badgeWidth-arcRadius, 2*arcRadius);
...
//- (void)setValueOnly:(NSUInteger)inValue
//{
//    _value = inValue;
//    self.hidden = ![[((UINavigationController *)QWGLOBALMANAGER.tabBar.viewControllers[0]).viewControllers lastObject] isKindOfClass:[NewHomePageViewController class]] || (self.hideWhenZero && _value == 0);
