...
@interface DiseaseDetailViewController ()<UITableViewDelegate, UITableViewDataSource,treatRuleBgViewDelegate,relateBgViewDelegate>
{
...
-(CGSize)getTextViewHeightWithContent:(NSString *)content FontSize:(CGFloat)fontSize width:(CGFloat)width
{
    if (content != nil && content.length > 0) {
        ...
        textViewTemp.font = font(kFont4, fontSize);
...
- (void)setDiseaseId:(NSString *)diseaseId
{
    ...
    detaileR.diseaseId=diseaseId;
    [Drug DiseaseDetailIosWithParam:detaileR success:^(id resultOBJ) {
        [self.diseaseDict addEntriesFromDictionary:resultOBJ];
...
//    }
    ...
    if ([self.diseaseType isEqualToString:@"A"]) {
        ...
        if (differentArray.count > 0) {
            ...
            for (NSString * item in differentArray) {
                ...
                [tmpRow setObject:font(kFont4, descFontSize) forKey:@"font"];
    ...
    for (int i = 0; i < formulaList.count; i++) {
        ...
        [formulaListDic setObject:font(kFont4, descFontSize) forKey:@"font"];
        [formulaListDic setObject:font(kFont4, titleFontSize) forKey:@"titleFont"];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    if (section == 0) {
        ...
        titleTextView.font = font(kFont4, titleFontSize);
...
//    }
    ...
    v.layer.borderColor = RGBHex(qwColor10).CGColor;
    return v;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0)//疾病简介
    {
        ...
        self.diseaseDescTextView.font =font(kFont4, descFontSize);
    ...
    }else if (indexPath.section == 1)//病因
    {
        ...
        [self.causebgView setBackgroundColor: RGBHex(qwColor16)];
        ...
        self.causeTitleTextView.font = font(kFont4, descFontSize);
        self.causeContentTextView.font =font(kFont4, descFontSize);
    ...
    }else if (indexPath.section == 2)//症状特点
    {
        ...
        [self.traitbgView setBackgroundColor:RGBHex(qwColor16)];
        ...
        self.traitTitleTextView.font = font(kFont4, descFontSize);
        self.traitContentTextView.font =font(kFont4, descFontSize);
    ...
    }else if (indexPath.section == 3)//易混淆疾病
    {
        ...
        if (cell == nil) {
            ...
            if ([isShow isEqualToString:@"YES"]) {
                ...
                [relateBoxView setBackgroundColor:RGBHex(qwColor16)];
        ...
        if ([isShow isEqualToString:@"YES"]) {
            ...
            t.font = font(kFont4, descFontSize);
...
//                NSString *similarDiseaseContent = [self replaceSpecialStringWith:self.diseaseDict[@"similarDiseaseContent"]];
            ...
            relateDiseaseLabel.font = font(kFont4, descFontSize);
            CGSize relateDiseaseSize = CGSizeFromString(self.diseaseDict[@"similarDiseaseContentSize"]);
        ...
        if (cell == nil) {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                threeButton.layer.borderColor = RGBHex(qwColor14).CGColor;
        ...
        titleText.font =font(kFont4, descFontSize);
        ...
        contentText.font = font(kFont4, descFontSize);
        ...
        if ([self.diseaseType isEqualToString:@"A"]) {
            ...
            for (int j = 0; j < 3; j++) {
                ...
                button.titleLabel.font = font(kFont4, titleFontSize);
                [button setTitleColor:RGBHex(qwColor14) forState:UIControlStateNormal];
        ...
        [self.habitbgView setBackgroundColor:RGBHex(qwColor16)];
        ...
        self.habitTitleTextView.font = font(kFont4, descFontSize);
        self.habitContentTextView.font = font(kFont4, descFontSize);
...
- (void)setRightBarButton{
    ...
    CGSize size = [GLOBALMANAGER sizeText:@"Aa" font:fontSystem(kFontS2)];
    UIButton * zoomButton = [UIButton buttonWithType:UIButtonTypeRoundedRect];
...
- (void)relateBgViewDiseaseButtonClick:(NSString *)buttonName button:(DisesaeDetailInfoButton *)button
{
    ...
    detaileIosR.diseaseName=buttonName;
    [Drug DiseaseDetailIosWithParam:detaileIosR success:^(id DFUserModel) {
        NSMutableDictionary *dic = [[NSMutableDictionary alloc] initWithCapacity:0];
        
        [dic addEntriesFromDictionary:DFUserModel];
        ...
        diseaseDetail.diseaseType = DFUserModel[@"type"];
        diseaseDetail.diseaseId = DFUserModel[@"diseaseId"];
