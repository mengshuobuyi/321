//
//  ProfessionInfoOneViewController.m
//  wenYao-store
//
...
@interface ProfessionInfoOneViewController ()<UIImagePickerControllerDelegate,UINavigationControllerDelegate>
...
@implementation ProfessionInfoOneViewController
...
- (IBAction)nextAction:(id)sender
{
    ...
    ProfessionInfoTwoViewController *vc = [[UIStoryboard storyboardWithName:@"ExpertAuth" bundle:nil] instantiateViewControllerWithIdentifier:@"ProfessionInfoTwoViewController"];
