...
- (void)setMsgBoxCell:(id)data
{
    ...
    self.lblTitle.font = fontSystem(QWAutoFontS4);
    self.lblContent.textColor = RGBHex(qwColor7);
    self.lblContent.font = fontSystem(QWAutoFontS5);
    self.lblTime.textColor = RGBHex(qwColor8);
    self.lblTime.font = fontSystem(QWAutoFontS5);
...
- (void)setCell:(id)data
{
    ...
    self.lblContent.font = fontSystem(QWAutoFontS4);
    self.lblTime.textColor = RGBHex(qwColor8);
    self.lblTime.font = fontSystem(QWAutoFontS5);
