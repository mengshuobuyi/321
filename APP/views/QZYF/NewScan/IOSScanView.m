...
- (void)setupCaptureSession {
    ...
    //x:(APP_W - self.SCAN_W )/ 2   =======y
    //y:(APP_H - self.SCAN_W)/2                =======x
    //w:220                 =======h
    //h:220                 =======w
    _ScanWidth=self.frame.size.width/2+100;
    [ _output setRectOfInterest : CGRectMake ((self.frame.size.height-_ScanWidth-80)/(2*self.frame.size.height),(self.frame.size.width - _ScanWidth )/(2*self.frame.size.width) , _ScanWidth / self.frame.size.height , _ScanWidth / self.frame.size.width )];
