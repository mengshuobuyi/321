...
+(NSString *)GetDirectoryForCaches:(NSString *)dir
{
    ...
    [QWFileManager addSkipBackupAttributeToItemAtURL:path];//不备份
...
+(NSString *)CreateList:(NSString *)List ListName:(NSString *)Name
{
    ...
    else
    {
        ...
        [QWFileManager addSkipBackupAttributeToItemAtURL:FileDirectory];//不备份
    }
...
/*
 ...
 ＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊
 */
+(BOOL)WriteFileDictionary:(NSDictionary *)DictionaryObject SpecifiedFile:(NSString *)path
{
