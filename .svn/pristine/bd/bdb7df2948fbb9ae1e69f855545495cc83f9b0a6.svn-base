...
//@implementation QWPostContentModel
//
//@end
//
//@implementation QWPostContentDetailModel
//- (instancetype)init
//{
//    if (self = [super init]) {
//        self.postContent = @"";
...
//{
//    self.postContent = model.postContent;
//    self.imgDesc = model.imgDesc;
...
//@implementation QWPostContentDetailWithImageModel
//
//
//@end
...
//- (NSArray*)allPostDrafts
//{
//    return [self.class getArrayFromDBWithWhere:nil];
//}
...
@implementation SilenceStatusModel
