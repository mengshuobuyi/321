...
- (void)setup {
    if (!_shareMenuItemButton) {
        ...
        shareMenuItemButton.frame = CGRectMake((APP_W/kXHShareMenuPerRowItemCount - 42)/2, 5, 42, 42);
    ...
    if (!_shareMenuItemTitleLabel) {
        UILabel *shareMenuItemTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(self.shareMenuItemButton.frame) + 3, APP_W/kXHShareMenuPerRowItemCount, 30)];
        shareMenuItemTitleLabel.backgroundColor = [UIColor clearColor];
        shareMenuItemTitleLabel.textColor = RGBHex(qwColor7);
        shareMenuItemTitleLabel.numberOfLines = 2;
    ...
    for (XHShareMenuItem *shareMenuItem in self.shareMenuItems) {
        ...
        CGRect shareMenuItemViewFrame = [self getFrameWithPerRowItemCount:kXHShareMenuPerRowItemCount
                                                        perColumItemCount:kXHShareMenuPerColum
                                                                itemWidth:APP_W/kXHShareMenuPerRowItemCount
