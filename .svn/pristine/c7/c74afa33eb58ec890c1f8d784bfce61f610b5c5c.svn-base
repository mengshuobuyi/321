...
typedef NS_ENUM(NSInteger, XHBubbleMessageOfficialTypeType) {
     XHBubbleMessageOfficialTypeReceiving,//官方
    XHBubbleMessageClentTypeSending  ,
    XHBubbleMessageStoreTypeReceiving
};
...
typedef NS_ENUM(NSInteger, XHBubbleMessageMediaType) {
    ...
    XHBubbleMessageMediaTypeSpreadHint = 14,
    XHBubbleMessageMediaTypeMedicine = 15,
    XHBubbleMessageMediaTypeMedicineSpecialOffers = 16,
    XHBubbleMessageMediaTypeMedicineShowOnce = 17,
    XHBubbleMessageMediaTypeMedicineSpecialOffersShowOnce = 18,
    XHBubbleMessageMediaTypeHeader = 19,
    XHBubbleMessageMediaTypeLine = 20,
    XHBubbleMessageMediaTypeFooter = 21,
    XHBubbleMessageMediaTypePhone = 22
};
