...
- (void)addNetView{
    ...
    noInternetView.backgroundColor = RGBHex(qwColor11);
//    view.center = self.view.center;
    ...
    UIImageView *im = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"img_network"]];
    im.frame = CGRectMake(50, 0, 150, 150);
    im.backgroundColor = RGBHex(qwColor11);
