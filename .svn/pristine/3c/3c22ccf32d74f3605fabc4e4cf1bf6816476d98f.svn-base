...
- (void)setup {
    if (!_emotionImageView) {
        UIImageView *emotionImageView = [[UIImageView alloc] initWithFrame:CGRectMake((self.frame.size.width - kXHEmotionImageViewSize)/2, 10, kXHEmotionImageViewSize, kXHEmotionImageViewSize)];
