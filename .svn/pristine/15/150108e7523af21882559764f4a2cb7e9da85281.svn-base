...
{
//     frame.size.height = MJRefreshViewHeight +20;
...
- (void)layoutSubviews
{
    ...
    // 1.状态标签
    self.statusLabel.frame = CGRectMake(statusX, statusHeight +5, statusWidth, statusHeight);
...
//                    self.arrowImage.transform = CGAffineTransformIdentity;
        ...
        {    self.activityView.hidden=YES;
            ...
            [self.imgvLoading startAnimating];
            //              }
            //              else {
            // 开始转圈圈
            self.imgBg .hidden = YES;
