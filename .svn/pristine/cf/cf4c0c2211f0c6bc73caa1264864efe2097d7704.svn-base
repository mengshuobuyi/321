...
+(CAAnimation *)GetRockerKeyAnimation:(float)angle direction:(QWAnimationRockDirection)direction
{
    ...
    switch (direction) {
        case QWAnimationRockDirectionRandom://随机
      {
        int tag = random()%2;
        if (tag) {
        ...
        case QWAnimationRockDirectionLeft://先左转
      {
        Animation.values = [NSArray arrayWithObjects:[NSNumber numberWithFloat:0],
                            [NSNumber numberWithFloat:-angle],
                            [NSNumber numberWithFloat:0],
        ...
        case QWAnimationRockDirectionRight://先右转
      {
        Animation.values = [NSArray arrayWithObjects:[NSNumber numberWithFloat:0],
                            [NSNumber numberWithFloat:angle],
                            [NSNumber numberWithFloat:0],
...
{
    CAAnimation * animation = [QWAnimation GetPointMoveBasicAnimation:startPoint endPoint:endPoint];
...
+(void)SetPointMoveShakeAnimation:(UIView *)targetView 
                       ...
                       startPoint:(CGPoint)startPoint 
                         endPoint:(CGPoint)endPoint
{
    CAAnimation * animation = [QWAnimation GetPointMoveKeyAnimationWithShake:shakeCount shakeDirection:isVertical startPoint:startPoint endPoint:endPoint];
    animation.delegate = delegate;
    animation.duration = duration;
    animation.repeatCount	= 1;
    [targetView.layer addAnimation:animation forKey:key];
...
{
    CAAnimation * animation = [QWAnimation GetRockerKeyAnimation:angle direction:direction];
    animation.delegate = delegate;
    animation.duration = duration;
    animation.repeatCount	= 1;
    [targetView.layer addAnimation:animation forKey:key];
...
+(void)SetRockerKeyAnimation:(UIView *)targetView 
                    ...
                    duration:(float)duration
                       angle:(float)angle 
{
    [QWAnimation SetRockerKeyAnimation:targetView delegate:delegate key:key duration:duration angle:angle direction:QWAnimationRockDirectionRandom];
}
...
{
    CAAnimation * animation = [QWAnimation GetKeyAnimationWithScale:scaleSize transform3D:targetView.layer.transform isFromView:YES];
    animation.delegate = delegate;
    animation.duration = duration;
    animation.removedOnCompletion = NO;
    animation.repeatCount	= 1;
...
+(void)SetScaleKeyAnimation:(UIView *)targetView
                 ...
                 isFromView:(BOOL)isFromView
{
    CAAnimation * animation = [QWAnimation GetKeyAnimationWithScale:scaleSize transform3D:targetView.layer.transform isFromView:isFromView];
    animation.delegate = delegate;
    animation.duration = duration;
    animation.removedOnCompletion = NO;
    animation.repeatCount	= 1;    
...
+(void)SetFlipKeyAnimation:(UIView *)targetView
                  delegate:(id)delegate
                      ...
                      time:(float)time
{
    CAAnimation * animation = [QWAnimation GetKeyAnimationWithScale:CGSizeMake(0.5, 0.5) transform3D:targetView.layer.transform isFromView:NO];
    ...
    CAAnimation * animation1 = [QWAnimation GetKeyAnimationWithScale:CGSizeMake(1.1, 1.1) transform3D:targetView.layer.transform isFromView:YES];
    ...
    CAAnimation * animation2 = [QWAnimation GetKeyAnimationWithScale:CGSizeMake(1.1, 1.1) transform3D:targetView.layer.transform isFromView:NO];
    ...
    CAAnimation * animation3 = [QWAnimation GetKeyAnimationWithScale:CGSizeMake(0.9, 0.9) transform3D:targetView.layer.transform isFromView:YES];
    ...
    CAAnimation * animation4 = [QWAnimation GetKeyAnimationWithScale:CGSizeMake(0.9, 0.9) transform3D:targetView.layer.transform isFromView:NO];
...
+(void)SetScaleRectKeyAnimation:(UIView *)targetView
                     ...
                     isFromView:(BOOL)isFromView
{
    CAAnimation * animation = [QWAnimation GetKeyAnimationWithScaleRect:scaleRect
...
{
    CAAnimation * animation = [QWAnimation GetRotationBasicAnimation:fromAngle toAngle:toAngle];
    animation.delegate = delegate;
    animation.duration = duration;
    animation.removedOnCompletion = NO;
    animation.repeatCount	= 1;
...
{
    CAAnimation * animation = [QWAnimation GetOpacityAnimation:fromValue toValue:toValue];
    animation.delegate = delegate;
    animation.duration = duration;
    animation.removedOnCompletion = NO;
    animation.repeatCount	= 1;
