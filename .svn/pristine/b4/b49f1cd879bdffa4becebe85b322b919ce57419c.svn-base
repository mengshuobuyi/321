...
+ (void)playMsgSound
{
    ...
    BOOL voiceEnable = [[userDefault objectForKey:APP_VOICE_NOTIFICATION] boolValue];
    if(voiceEnable)
        [XHAudioPlayerHelper playSoundWithName:@"msg" type:@"aiff"];
    BOOL vibration = [[userDefault objectForKey:APP_VIBRATION_NOTIFICATION] boolValue];
    if(vibration)
    {
