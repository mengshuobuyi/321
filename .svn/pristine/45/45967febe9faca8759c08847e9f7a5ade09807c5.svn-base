...
//    DebugLog(@"touch：%@",event);
    [self hide:YES];
    
    if ([self.delegate respondsToSelector:@selector(hudStopByTouch:)]) {
...
- (void)layoutSubviews {
    ...
    CGSize labelSize = [label.text sizeWithAttributes:[NSDictionary dictionaryWithObjectsAndKeys:label.font,NSFontAttributeName, nil]];//[label.text sizeWithFont:label.font];
    ...
    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize
                                                              options:NSStringDrawingUsesLineFragmentOrigin attributes:[NSDictionary dictionaryWithObjectsAndKeys:detailsLabel.font,NSFontAttributeName, nil]
                                                              context:nil].size;
//    [detailsLabel.text sizeWithFont:detailsLabel.font constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
