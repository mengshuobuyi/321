...
{
    //NSLog(@"delegate");
    if (delegate && [delegate respondsToSelector:@selector(QWCoreMotionWidthx:y:z:)]) {
        [delegate QWCoreMotionWidthx:x y:y z:z];
    }
}
